...
{
    public class InvoiceReportsApiHelper
    {
        private readonly string _apiKey;
        private readonly string _timeProUrlId;

        public InvoiceReportsApiHelper(string timeProUrlId, string apiKey)
        {
        ...
        {
            get { return "https://" + _timeProUrlId + ".sswtimepro.com/api/InvoiceReports/"; }
        } 
